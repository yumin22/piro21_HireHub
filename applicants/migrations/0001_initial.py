...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='interview_date',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='interview_date', to='applicants.possible_date_list'),
        ),
        migrations.AddField(
            model_name='application',
            name='interviewer',
        ...
        migrations.AddField(
            model_name='application',
            name='possible_date',
            field=models.ManyToManyField(blank=True, to='applicants.possible_date_list'),
        ),
        migrations.AddField(
            model_name='application',
            name='template',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='template.applicationtemplate'),
        ),
        migrations.CreateModel(
            name='Answer',
            fields=[
