    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('submitted', '서류 제출'), ('interview_scheduled', '면접 대기'), ('interview_in_progress', '면접 진행 중'), ('interview_completed', '면접 완료')], default='submitted', max_length=50)),
                ('interview_team', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='interview_team', to='accounts.interviewteam')),
                ('interviewer', models.ManyToManyField(limit_choices_to={'is_active': True, 'is_approved': True}, to=settings.AUTH_USER_MODEL)),
